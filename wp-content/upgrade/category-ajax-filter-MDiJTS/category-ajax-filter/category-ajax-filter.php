<?php
/*
Plugin Name: Filter Posts By Category
...
if (!defined('CAF_CURRENT_VERSION')){
    define('CAF_CURRENT_VERSION', '1.0');
}
...
class TC_CAF_Plugin {
	...
	//load_plugin_textdomain( 'tc_caf_domain', false, dirname( plugin_basename(__FILE__) ) . '/lang/' );
    }
	...
	public function tc_caf_plugin_constants(){
		...
		if ( ! defined( 'TC_CAF_PLUGIN_VERSION' ) ) {
			define( 'TC_CAF_PLUGIN_VERSION','1.0' );
		}
	}
}
