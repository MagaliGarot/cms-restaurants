<div class="tab-pane tab-pad" id="shortcode" role="tabpanel" aria-labelledby="shortcode-tab">
	<div class="manage-top-dash shortcode-tab"><span class="dashicons dashicons-shortcode"></span><?php echo esc_html('Shortcode','tc_caf');?> <a href='<?php echo esc_url('http://trustyplugins.com','tc_caf');?>' target="_blank"><i class="fa fa-info-circle" aria-hidden="true"></i> <?php echo esc_html('Documentation','tc_caf');?></a></div>
	<div id="tabs-panel">
