<div class="tab-pane" id="typography" role="tabpanel" aria-labelledby="typography-tab">
	...
	<div class="manage-top-dash general-tab"><span class="dashicons dashicons-editor-spellcheck"></span> <?php echo esc_html('Typography','tc_caf'); ?> <a href='<?php echo esc_url('http://trustyplugins.com','tc_caf');?>' target="_blank"><i class="fa fa-info-circle" aria-hidden="true"></i> <?php echo esc_html('Documentation','tc_caf');?></a></div>
