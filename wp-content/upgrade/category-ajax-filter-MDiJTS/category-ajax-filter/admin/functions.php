...
class CAF_Meta_Boxes {  
	...
	/* Verify the nonce before proceeding. */
	  ...
	  {
	  $desktop_large="3";$desktop="3";$tablet="2";$mobile="1";
  ...
  $caf_col_opt=array("caf_col_desktop_large"=>$desktop_large,"caf_col_desktop"=>$desktop,"caf_col_tablet"=>$tablet,"caf_col_mobile"=>$mobile);
	...
	<div class="logo-helper"><a href='http://trustyplugins.com' target="_blank"><img src="<?php echo TC_CAF_URL;?>/admin/images/full-logo.png"></a></div>
	  <!-- Nav tabs -->
	<ul class="nav nav-tabs" id="myTab" role="tablist">
	  <li class="nav-item" role="presentation">
		<a class="nav-link active" id="general-tab" data-toggle="tab" href="#general" role="tab" aria-controls="general-tab" aria-selected="true"><?php echo esc_html('General');?> <br/><span class="info-bt"><?php echo esc_html('Post Type, Categories','tc_caf'); ?> </span><span class="dashicons dashicons-admin-tools"></span></a>
	  </li>
	  <li class="nav-item" role="presentation">
		<a class="nav-link" id="appearance-tab" data-toggle="tab" href="#appearance" role="tab" aria-controls="appearance-tab" aria-selected="false"><?php echo esc_html('Appearance','tc_caf');?> <br/><span class="info-bt"><?php echo esc_html('Post Layout, Filter Layout','tc_caf'); ?></span><span class="dashicons dashicons-visibility"></span></a>
	  </li>
	  <li class="nav-item" role="presentation">
		<a class="nav-link" id="typography-tab" data-toggle="tab" href="#typography" role="tab" aria-controls="typography-tab" aria-selected="false"><?php echo esc_html('Typography','tc_caf');?> <br/><span class="info-bt"><?php echo esc_html('Title, Description Fonts','tc_caf'); ?></span><span class="dashicons dashicons-editor-spellcheck"></span></a>
	  </li>
	  <li class="nav-item" role="presentation">
		<a class="nav-link" id="advanced-tab" data-toggle="tab" href="#advanced" role="tab" aria-controls="advanced-tab" aria-selected="false"><?php echo esc_html('Advanced','tc_caf'); ?> <br/><span class="info-bt"><?php echo esc_html('Add Extra Classes to Post','tc_caf'); ?></span><span class="dashicons dashicons-tag"></span></a>
	  </li>
		<li class="nav-item" role="presentation">
		<a class="nav-link" id="shortcode-tab" data-toggle="tab" href="#shortcode" role="tab" aria-controls="shortcode-tab" aria-selected="false"><?php echo esc_html('Shortcode','tc_caf'); ?> <br/><span class="info-bt"><?php echo esc_html('Get Your shortcode','tc_caf'); ?></span><span class="dashicons dashicons-shortcode"></span></a>
	  </li>
		<li class="nav-item" role="presentation">
		<a class="nav-link" id="import-tab" data-toggle="tab" href="#import" role="tab" aria-controls="import-tab" aria-selected="false"><?php echo esc_html('Import Layout','tc_caf'); ?> <br/><span class="info-bt"><?php echo esc_html('Import Layout from Demo Site','tc_caf'); ?></span><span class="dashicons dashicons-controls-repeat"></span></a>
	  </li>
	</ul>
	</div>
	<!-- Tab panes -->
...
public function __construct() {
	...
	$caf_filter_layout=get_post_meta($id,'caf_filter_layout',true);
		...
		wp_enqueue_style('tc-caf-'.$caf_filter_layout, TC_CAF_URL.'/assets/css/filter/"'.$caf_filter_layout.'".min.css','',TC_CAF_PLUGIN_VERSION);		
			...
			//wp_enqueue_script('tc-caf-smooth-scroll',TC_CAF_URL . 'assets/js/smooth-scroll.js', 'array(jquery)', TC_CAF_PLUGIN_VERSION);	
			//wp_enqueue_script( "tc-caf-smooth-scroll");
		}
		return $posts;
	}
	public function tc_caf_enqueue_scripts(){
	wp_register_script('tc-caf-frontend-scripts',TC_CAF_URL . 'assets/js/script.min.js', array(), TC_CAF_PLUGIN_VERSION);
	//wp_register_script('tc-caf-smooth-scroll',TC_CAF_URL . 'assets/js/smooth-scroll.js', array(), TC_CAF_PLUGIN_VERSION);	
	...
	//wp_enqueue_script( 'tc-caf-frontend-scripts', TC_CAF_URL .'assets/js/script.js', array('jquery'));	
	}
}
...
$layouts=array("post-layout1"=>'Layout 1',"post-layout2"=>'Layout 2',"post-layout3"=>'Layout 3',"post-layout4"=>'Layout 4');	
return $layouts;
}
}
